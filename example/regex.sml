(*
Example Standard ML program from Robert Harper in his book
...
val matches: string -> bool = match regexp;
val ex1: bool = matches "aabba";
val ex2: bool = matches "abac";

print("aabba matches (a+b)*: " ^ (Bool.toString (ex1)) ^ "\n");
print("abac matches (a+b)*: " ^ (Bool.toString (ex2)) ^ "\n");